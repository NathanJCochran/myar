...
testt12345:
	rm -f ar12345.ar myar12345.ar
	ar q ar12345.ar 1-s.txt 2-s.txt 3-s.txt 4-s.txt 5-s.txt
	ar t ar12345.ar > ar-ctot.txt
	./myar -t ar12345.ar > myar-ctot.txt
	diff ar-ctot.txt myar-ctot.txt
	@echo

testt135:
	rm -f ar135.ar myar135.ar
	ar q ar135.ar 1-s.txt 3-s.txt 5-s.txt
	ar t ar135.ar > ar-ctot.txt
	./myar -t ar135.ar > myar-ctot.txt
	diff ar-ctot.txt myar-ctot.txt
	@echo
...
testt24:
	rm -f ar24.ar myar24.ar
	ar q ar24.ar 2-s.txt 4-s.txt
	ar t ar24.ar > ar-ctot.txt
	./myar -t ar24.ar > myar-ctot.txt
	diff ar-ctot.txt myar-ctot.txt
	@echo
